---
title: He Became for Us Righteousness
book_id: 1CO
chapter: 1
verse: 30
resource_type:
...
Regarding sanctification: long ago I heard the term "unfolding revelation" to describe sanctification. I can't remember where I first heard it, but I like that language. Rather than sanctification being a process, which lends itself to works and effort, revelation is the language of understanding who we are in Christ and what He has accomplished.

We have to know that we *are* sanctified before we can actually *live* sanctified. If not, no amount of yielding to a process will ever bring us to the "destination" of sanctified. Sanctification (and holiness) is a pre-ethical term, meaning that the identity comes before the actual evidence of it is even seen; and its that identity which then produces Christ-like behavior. Most of us have that backwards ("I have to act like it to earn the title"). If we believe that sanctified is the starting line of our walk with Jesus, not the finish line, then we actually live out the identity that God speaks over us...sanctified by the blood of the Lamb. Christ is our sanctification.

## Cross References (re: sanctification)
